...
async function getResources() {
    ...
    const roleAccess = await fetchJSON('https://api.scyted.tv/website/staff-portal/role-access.json');
    const resources = await fetchJSON('https://api.scyted.tv/website/staff-portal/resources.json');
